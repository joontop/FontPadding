export default {
    ...
    CSS: [
        ...
        '#__fontPaddingDrawerTurnner.on:before{background-color:#f00;}',
        ...
        '#__fontPaddingUp{overflow:hidden;display:none;border:1px solid rgba(255,255,255,0.4);font-family:helvetica neue,tahoma,sans-serif;margin-left:-10px;position:absolute;z-index:100000;width:20px;height:20px;font-size:10px;font-weight:bold;line-height:20px;text-align:center;color:#fff;background-color:rgba(255,0,0,0.9);border-radius:100%;}',
        '#__fontPaddingDown{overflow:hidden;display:none;border:1px solid rgba(255,255,255,0.4);font-family:helvetica neue,tahoma,sans-serif;margin-left:-10px;position:absolute;z-index:100000;width:20px;height:20px;font-size:10px;font-weight:bold;line-height:20px;text-align:center;color:#fff;background-color:rgba(255,0,0,0.9);border-radius:100%;}',
