...
import UpDownGuider from './components/UpDownGuider'
import Canvas from './components/Canvas'
import TextGuider from './components/textGuider'
...
var start = function () {
  ...
  var upDownGuider = new UpDownGuider();
  ...
  function actionFontPadding () {
    ...
    setTimeout(function () {
      canvas.create(textGuider.element).then(() => canvas.calculate());
    }.bind(this), 20);
